...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fieldObsIdText = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        fieldTempText = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        fieldBloodPressureText = new javax.swing.JTextField();
        ...
        fieldObsIdText.setEnabled(false);
        add(fieldObsIdText, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 74, 97, -1));

        jLabel3.setText("Temperature:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 123, -1, -1));
        add(fieldTempText, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 118, 97, -1));

        jLabel4.setText("Blood Pressure:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 167, -1, -1));
        add(fieldBloodPressureText, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 162, 97, -1));
    ...
    private void viewObsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewObsBtnActionPerformed
        ...
        if(selectedRow >= 0){
            ...
            //fill all textfields
            fieldObsIdText.setText(String.valueOf(this.selectedObs.getObservationId()));
            fieldTempText.setText(String.valueOf(this.selectedObs.getTemperature()));
            fieldBloodPressureText.setText(String.valueOf(this.selectedObs.getBloodPressure()));
    ...
    private void updObsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updObsBtnActionPerformed
        // TODO add your handling code here:
       if( !fieldObsIdText.getText().isEmpty()){ 
        //update the observation object
        
            Observation o = this.application.getHistory().findObservation(Integer.valueOf(fieldObsIdText.getText()));
            o.setBloodPressure(Double.valueOf(fieldBloodPressureText.getText()));
            o.setTemperature(Double.valueOf(fieldTempText.getText()));


            this.selectedObs.setBloodPressure(Double.valueOf(fieldBloodPressureText.getText()));
            this.selectedObs.setTemperature(Double.valueOf(fieldTempText.getText()));
       } else {
    ...
    private javax.swing.JTextField fieldBloodPressureText;
    private javax.swing.JTextField fieldObsIdText;
    private javax.swing.JTextField fieldTempText;
